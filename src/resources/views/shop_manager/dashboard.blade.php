...
@section('content')
    ...
    <div class="container reservations-container">
        ...
        <h3 id="qr-data-display" class="content-section-title">
            QRコード照会内容
        </h3>
        <div class="reservation-details hide" id="reservation-details">
            ...
            <p class="qr_data_content qr-email-column-section"><strong>メールアドレス:</strong> <span
                    id="reservation-email"></span></p>
        </div>
