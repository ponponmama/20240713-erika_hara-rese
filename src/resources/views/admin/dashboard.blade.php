    ...
    <div class="management_form shop_manager_form">
        ...
        <form action="{{ route('admin.create.shop_manager') }}" method="POST" class="admin-form create-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="user_name" name="user_name" placeholder="Username" value="{{ old('user_name') }}" class="date-entry" autocomplete="username">
            </div>
            <p class="form__error">
                @error('user_name')
                    {{ $message }}
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" placeholder="Email" value="{{ old('email') }}" class="date-entry" autocomplete="email">
            </div>
            <p class="form__error">
                @error('email')
                    {{ $message }}
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" placeholder="Password" value="{{ old('password') }}" class="date-entry" autocomplete="new-password">
            </div>
            <p class="form__error">
                @error('password')
                    {{ $message }}
    ...
    <div class="management_form shop_registration_form">
        ...
        <form action="{{ route('admin.create.shop') }}" method="POST" class="admin-form create-shop-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="genre_name" placeholder="Genre" value="{{ old('genre_name') }}" class="date-entry">
            </div>
            <p class="form__error">
                @error('genre_name')
                    {{ $message }}
            ...
            <div class="form-group">
                ...
                <input type="text" name="area_name" placeholder="Area" value="{{ old('area_name') }}" class="date-entry">
            </div>
            <p class="form__error">
                @error('area_name')
                    {{ $message }}
