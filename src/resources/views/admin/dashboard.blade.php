...
<div class="container admin_container">
    ...
    <div class="management_form shop_manager_form">
        <h2 class="title-name section-title">店舗代表者登録</h2>
        ...
        <form action="{{ route('admin.create.shop_manager') }}" method="POST" class="admin-form create-form">
            ...
            <div class="input-group">
                ...
                <input type="text" id="user_name" name="user_name" placeholder="Username" value="{{ old('user_name') }}" class="data-entry admin-input">
            </div>
            <p class="form__error">
                @error('user_name')
                    {{ $message }}
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" name="email" placeholder="Email" value="{{ old('email') }}" class="data-entry admin-input">
            </div>
            <p class="form__error">
                @error('email')
                    {{ $message }}
            ...
            <div class="input-group">
                ...
                <input type="password" id="password" name="password" placeholder="Password" value="{{ old('password') }}" class="data-entry admin-input">
            </div>
            <p class="form__error">
                @error('password')
                    {{ $message }}
    ...
    <div class="management_form shop_registration_form">
        <h2 class="title-name section-title">新規店舗登録</h2>
        ...
        <form action="{{ route('admin.create.shop') }}" method="POST" class="admin-form create-shop-form" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <img src="{{ asset('images/shop.png') }}" alt="" class="icon-img">
                <input type="text" name="shop_name" placeholder="Shop Name" value="{{ old('shop_name') }}" class="data-entry admin-input">
            </div>
            <p class="form__error">
                @error('shop_name')
                    {{ $message }}
            ...
            <div class="input-group">
                ...
                <textarea name="description" placeholder="Description" class="data-entry admin-input description_text">{{ old('description') }}</textarea>
            </div>
            <p class="form__error">
                @error('description')
                    {{ $message }}
            ...
            <div class="input-group">
                ...
                <input type="text" name="genre_name" placeholder="Genre" value="{{ old('genre_name') }}" class="data-entry admin-input">
            </div>
            <p class="form__error">
                @error('genre_name')
                    {{ $message }}
            ...
            <div class="input-group">
                ...
                <input type="text" name="area_name" placeholder="Area" value="{{ old('area_name') }}" class="data-entry admin-input">
            </div>
            <p class="form__error">
                @error('area_name')
                    {{ $message }}
            ...
            <div class="input-group-time">
                ...
                <input type="time" id="open_time" name="open_time" class="data-entry time-input admin-input">
            </div>
            <p class="form__error">
                @error('open_time')
                    {{ $message }}
