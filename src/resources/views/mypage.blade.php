                ...
                <div class="reservation-summary">
                    <form action="{{ route('reservations.update', $reservation->id) }}" method="POST" id="update-form-{{ $reservation->id }}" class="update_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <input type="date" name="date" class="data-entry input_date" value="{{ \Carbon\Carbon::parse($reservation->reservation_datetime)->format('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="reservation-button-container">
                        <button type="submit" class="button reservation-button edit-reservation-button" form="update-form-{{ $reservation->id }}">
                            変更
                        </button>
                        <button type="submit" class="button reservation-button delete-reservation-button" form="delete-form-{{ $reservation->id }}">
                            削除
                        </button>
                        @if($reservation->payment_status !== 'completed')
                            <a href="{{ route('payment.form', ['reservation_id' => $reservation->id]) }}" class="button reservation-button edit-reservation-button">
                                支払う
                            </a>
                        @endif
